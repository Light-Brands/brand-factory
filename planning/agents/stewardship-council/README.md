...
flowchart TB
    ...
    subgraph AGENTS["Seven Archetypal Intelligences"]
        direction LR
        A1["🔮 Oracle of<br/>Soul Purpose"]
        A2["🌱 Guardian<br/>of Gaia"]
        A3["💠 Architect of<br/>Sacred Systems"]
        A4["🔥 Flame of Cultural<br/>Restoration"]
        A5["🌀 Weaver of<br/>Collective Futures"]
        A6["⚖️ Steward of<br/>Exchange"]
        A7["🪞 Mirror of the<br/>Multiverse"]
    end

    subgraph ALIGNMENT["Triple Alignment"]
        direction LR
        AL1["🧘 Individual<br/>Soul Path"]
        AL2["🌍 Earth's Living<br/>Systems"]
        AL3["✨ Universal<br/>Harmonic Field"]
    end
