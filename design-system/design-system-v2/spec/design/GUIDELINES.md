...
**Version:** 2.0.0 **Last Updated:** 2025-12-19 **Purpose:** AI-optimized design
patterns and development standards

> **Note**: This document now references the Onyx Design System dark mode palette. 
> All components use colors from `design-system-v2/tokens/colors.ts`.
> See `ui-component-library.md` for the complete component mapping table.
...
-../design/README.md` - Design system entry point
-../design/CODEX_USAGE.md` - AI agent prompting guide
-../design/existing-patterns.json` - Detailed pattern examples
