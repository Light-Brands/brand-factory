 ...
 * @see design-system-v2/tokens/ for color tokens
 * @see design-system-v2/pages/Showcase.tsx for page layout reference
 *
 * Onyx Design System Colors:
 * - Background: abyss-base (#0D0D0D) - full page bg
 * - Cards: abyss-mystic (#121212) with border-white/5
 * - Text: moonlight (#F5F5F5) primary, moonlight-muted (#A0A0A0) secondary
 * - Accent: aqua-light (#97D9C4) for interactive elements
 */
