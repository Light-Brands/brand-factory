...
Use the appropriate template fro../design/templates/ for your task.
...
```
Rea../design/tools/cursor-prompt-base.txt first.
...
Us../design/templates/component-template.tsx as the base.
Referenc../design/templates/example-community-card.tsx for patterns.
```

**Creating a New Page:**

```
Follow the design system i../design/GUIDELINES.md.
...
Us../design/templates/page-template.tsx as the starting point.
Referenc../design/templates/example-discover-page.tsx for patterns.
```

**Creating a New Hook:**

```
Rea../design/tools/cursor-prompt-base.txt and follow all rules.
...
Base it o../design/templates/hook-template.ts.
```
...
□ Read relevant template fro../design/templates/
