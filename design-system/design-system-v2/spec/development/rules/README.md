...
> **Onyx Design System**: When implementing UI components, reference `design-system-v2/components/`
> for 50+ production-ready implementations and `design-system-v2/tokens/` for design tokens.
> See `design-system-v2/pages/Showcase.tsx` for live examples of all components.
