...
3. **Brand Integration**: Read [`brand-identity-integration.md`](brand/brand-identity-integration.md)
4. **Component Library**: Read [`ui-component-library.md`](design/ui-component-library.md)
...
```
design-system-v2/spec/          # Unified with Onyx Design System
...
│
├── architecture/               # Technical system design (6 docs)
│   ├── README.md
