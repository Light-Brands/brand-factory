...
> **Onyx Design System**: Business UI uses dark mode palette from `design-system-v2/tokens/`.
> See `components/BusinessComponents.tsx` for ListingCard, VerificationBadge, BusinessProfileEditor implementations.
