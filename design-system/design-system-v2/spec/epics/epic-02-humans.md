...
> **Onyx Design System**: Profile UI uses dark mode palette from `design-system-v2/tokens/`.
> See `components/ProfilePageComponents.tsx`, `ProfileComponents.tsx`, `ProfileHeader.tsx` for implementations.
...
//   "Introducing VIBES - your new feed
//   
