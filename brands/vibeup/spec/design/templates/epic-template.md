...
**Follow these guidelines (se../design/GUIDELINES.md):**
...
- Patterns:../design/existing-patterns.json`
...
-../design/GUIDELINES.md` - Development standards
-../design/existing-patterns.json` - Code patterns
