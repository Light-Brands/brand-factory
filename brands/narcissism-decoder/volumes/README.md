...
|-----|-------|-------|--------|
| 1 | **The Narcissism Decoder** | Recognition & Breaking Free | Active |
| 2 | **The Bridge** | Attachment Repair | Planned |
| 3 | *TBD* | — | Planned |
| 4 | *TBD* | — | Planned |
| 5 | *TBD* | — | Planned |
| 6 | *TBD* | — | Planned |
...
[Read more →](./vol-1-narcissism-decoder/README.md)

### Volume 2: The Bridge
**Theme:** Attachment Repair & Secure Relating

After recognizing dysfunction, readers learn to build what may never have been modeled: secure attachment. Moving from hypervigilance to discerning trust, from isolation to genuine connection.

[Read more →](./vol-2-bridge/README.md)
...
### Linear Journey
Read all volumes in order for the complete transformation arc.

### Crisis Entry
If in immediate danger, start with Volume 1's crisis path:
- Chapter 18 (Practical Responses)
- Chapter 2 (Body-Based Recognition)
- Chapter 17 (Nervous System Grounding)

### Topic-Specific
Each volume can stand alone for readers seeking specific support.
