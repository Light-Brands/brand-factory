...
- [ ] What is Kinship Earth's current legal status? Active 501(c)(3)? State of incorporation?
- [ ] What's the current board composition?
- [ ] Is Sydney the sole staff member, or are there others?
- [ ] What's the current annual budget and funding pipeline?

### Funding Strategy
- [ ] What grant programs are being targeted? (USDA, state conservation, family foundations, climate funds?)
- [ ] What's the flow funding strategy? Who are the flow funders in the network?
- [ ] What's the donor cultivation pipeline? Major donors, mid-level, grassroots?
...
- [ ] What reporting frameworks are in use? (IRIS+, custom, funder-specific?)
- [ ] How is the ecosystem's collective impact measured and communicated?

### Digital Presence
- [ ] Current website status and needs?
- [ ] Donor communication channels -- newsletter, social, annual report?
- [ ] Online donation infrastructure -- platform, recurring giving, campaign pages?
...
- Family foundations focused on regenerative agriculture, land access, community resilience
- Flow funding networks (e.g., RSF Social Finance, Thousand Currents)
- Impact investors focused on regenerative real estate / land stewardship
