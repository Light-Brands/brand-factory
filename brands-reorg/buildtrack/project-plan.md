...
📄 [Full Specification](./phases/00-environment.md)
...
📄 [Full Specification](./phases/01-foundation.md)
...
📄 [Full Specification](./phases/02-core-features.md)
...
📄 [Full Specification](./phases/03-advanced-features.md)
...
📄 [Full Specification](./phases/04-polish-demo.md)
...
|----------|-------------|
| [brand-identity-guide.md](./spec/brand/brand-identity-guide.md) | Visual identity, colors, typography, voice |
| [spec-overview.md](./spec-overview.md) | This document—high-level plan |
| [phases/00-environment.md](./phases/00-environment.md) | Infrastructure setup |
| [phases/01-foundation.md](./phases/01-foundation.md) | Core architecture |
| [phases/02-core-features.md](./phases/02-core-features.md) | Employee experience |
| [phases/03-advanced-features.md](./phases/03-advanced-features.md) | Admin workflows |
| [phases/04-polish-demo.md](./phases/04-polish-demo.md) | Demo preparation |
...
2. Read the [Brand Identity Guide](./spec/brand/brand-identity-guide.md) for visual direction
3. Begin with [Phase 0](./phases/00-environment.md) to set up environments
