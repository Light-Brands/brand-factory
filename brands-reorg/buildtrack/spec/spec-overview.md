...
|----------|-------------|
| [brand-identity-guide.md](./brand/brand-identity-guide.md) | Visual identity, colors, typography, voice |
...
2. Read the [Brand Identity Guide](./brand/brand-identity-guide.md) for visual direction
