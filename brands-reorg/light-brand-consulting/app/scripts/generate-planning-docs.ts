...
const BRANDS_ROOT = path.resolve(__dirname, '../../../');
const OUTPUT_FILE = path.resolve(__dirname, '../src/data/planning-docs.ts');
 ...
 *
 * DO NOT EDIT — run \`npm run generate-docs\` to regenerate.
 */
