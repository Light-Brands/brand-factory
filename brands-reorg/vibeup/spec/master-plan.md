...
VIBEUP is the world's first social wellness platform where individuals, businesses, and communities connect through shared values, mindful practices, and authentic experiences. We transform social engagement into purposeful action through two foundational primitives integrated from day one:

1. **Mira** — Our omnipresent AI platform concierge who serves as the emotional anchor, intelligent guide, and core differentiator across every aspect of the user experience.

2. **Crypto Financial Layer** — A seamless Web3 infrastructure enabling peer-to-peer payments, VIBES token rewards for practices and engagement, and conscious commerce—making financial interactions as natural as messaging.
...
Unlike platforms that bombard users with feeds or funnels, VIBEUP curates **guided pathways to self-discovery, meaningful connection, and conscious commerce**—with Mira as your personal guide and crypto as your financial backbone at every step. Mira ensures every interaction feels human, purposeful, and emotionally resonant, while the crypto layer makes value exchange seamless and rewarding.

**Our Moat - Two Foundational Primitives**:

**1. Mira as Platform Concierge**: While competitors offer static onboarding or generic recommendation engines, Mira is:
...
**2. Crypto Financial Layer as Value Infrastructure**: While traditional wellness platforms use clunky payment forms and offer no tangible rewards for engagement, VIBEUP's crypto layer provides:
- **Seamless P2P Payments**: Send money to anyone using just their @handle—no wallet addresses or crypto complexity
- **VIBES Token Rewards**: Earn tokens for daily practices, streaks, and community contributions
- **Hybrid Wallets**: Users get wallets automatically on signup—no seed phrases or crypto knowledge required
- **In-Chat Payments**: Request and send payments naturally within conversations
- **Staking for Benefits**: Lock VIBES tokens to unlock premium features and governance power
- **Soul-Bound Achievement NFTs**: Non-transferable badges for milestone achievements (7-day streak, 100 practices)
- **Community Treasuries**: Shared wallets for crowdfunding events and collective initiatives
- **Conscious Commerce**: Business payments, tips, and split bills—all through the platform

**Crypto Router Service**: A unified service layer that abstracts blockchain complexity, enabling multi-chain support (Base L2, Solana, Polygon) while presenting a simple interface to the rest of the platform. See [`crypto-router.md`](architecture/crypto-router.md) for complete specification.

**VIBES Tokenomics**: A dual-token model with VIBES utility tokens for rewards and payments, and future governance tokens for platform direction. See [`vibe-tokenomics.md`](architecture/vibe-tokenomics.md) for complete token economics.

**Target Outcome**: Users feel accompanied by an intelligent, empathetic companion who understands their journey—creating an experience where they feel seen, supported, and purposefully guided at every moment, not algorithmically optimized or monetarily extracted. Financial interactions feel as natural as messaging, rewarding engagement while enabling conscious commerce.
...
Crypto Financial Layer: Multi-chain Web3 infrastructure (see crypto-router.md)
  - Primary Chain: Base L2 (low fees, Coinbase ecosystem)
  - Secondary: Solana (high throughput for micro-transactions)
  - Tertiary: Polygon (EVM compatibility, established DeFi)
  - Wallet Provider: Dynamic or Privy (social login → wallet abstraction)
  - Stablecoin: USDC (primary payment currency)
  - Native Token: VIBES (rewards, staking, governance)
  - Soul-Bound Tokens: ERC-5192 (non-transferable achievement NFTs)
  - MPC Security: Fireblocks or Fordefi (institutional-grade key management)
  - Architecture: Provider-agnostic router with chain adapter pattern
...
graph TB
    ...
    subgraph blockchain [Blockchain Layer - Multi-Chain]
        base[Base L2]
        solana[Solana]
        polygon[Polygon]
        usdc[USDC Contracts]
...
**Timeline**: 2-3 weeks  
**Goal**: Build stable, observable infrastructure with crypto primitives  
...
- **Crypto database tables created** (wallets, transactions, balances, rewards)
- **CryptoRouterService foundation** (wallet manager, chain adapter interface)
- **VIBES token contract deployed** (testnet)
...
- **VIBES token transfers work on testnet**

### Phase 1: MVP (Individual Users) - Mira & Crypto Establish Foundation

**Timeline**: 8-10 weeks total  
**Goal**: Validate engagement and emotional resonance through Mira's intelligent guidance and seamless crypto rewards  
**User Targets**: 
- 20-100 for profiles
...
**Epics Included**:
1. **Epic 1A - Crypto Financial Layer** (runs in parallel with Epic 1)
   - Automatic wallet creation on signup (hybrid custodial)
   - @handle-based identity for payments
   - VIBES token reward engine for practices
   - Basic P2P transfers within messaging
   - Wallet settings in profile
   - Mira crypto context awareness
2. Epic 1 - Mira (Onboarding, Account Creation, Intention Setting, Daily Guidance)
   ...
   - **Crypto-aware prompts**: Wallet onboarding, reward explanations, payment guidance
   - Roadmap tracked: Account de-duping, mood capture
3. Epic 2 - Human Profiles (Identity, Chemistry, Attributes) - **Mira guides profile completion**
   ...
   - **@handle display on profile, "Pay" button, wallet settings**
4. Epic 3 - Practices (Tracking, Streaks, Accountability) - **Mira suggests and celebrates practices**
   - **VIBES rewards for practice completion**
   - **Streak multipliers (1.5x at 7 days, 2x at 30 days)**
   - **Soul-Bound NFT for 100-practice milestone**
5. Epic 4 - Discovery (Social Discovery, Messaging, Map) - **Mira explains connections and facilitates matching**
   - **In-chat P2P payments via @handle**
   - **Payment request creation and fulfillment**
6. Epic 5 - Impact (Voting, Feedback, Co-Creation) - **Mira collects feedback and explains influence**
   - **VIBES-weighted voting for features/initiatives**
...
- **New**: Wallet activation: 90%+ users have wallets created automatically
- **New**: VIBES earned: 50%+ of active users earn VIBES through practices
- **New**: P2P payment adoption: 20%+ of messaging users send/receive payments

### Phase 2: Growth & Conscious Commerce - Mira & Crypto Expand Ecosystem
...
6. Epic 6 - Business Profiles (Verification, Services, Perks, Listings) - **Mira recommends services and explains value**
   - **Accept USDC for services**
   - **Crypto payment option at checkout**
   - **Instant crypto payouts to business wallets**
   - **Direct tipping for service providers**
7. Epic 7 - Communities (Constellations, Posts, Moderation, Transformation) - **Mira suggests communities and encourages participation**
   ...
   - **Community treasury (shared wallet)**
   - **Pay membership dues in USDC/VIBES**
   - **Crowdfund events through treasury**
8. Epic 8 - Monetization (Memberships, Affiliates, Stripe, Sponsorships) - **Mira frames upgrades as growth tools, not transactions**
   ...
   - **Pay subscriptions in USDC or VIBES**
   - **VIBES staking for premium feature access**
   - **Instant crypto affiliate payouts**
...
graph LR
    ...
    epic0 --> epic1a[Epic 1A<br/>Crypto]
    epic0 --> epic1b[Epic 1B<br/>Karma]
    ...
    epic1a --> epic4
    epic1a --> epic5
    epic1a --> epic6[Epic 6<br/>Business]
    epic1a --> epic7[Epic 7<br/>Community]
    epic1a --> epic8[Epic 8<br/>Monetization]
    ...
    style epic1a fill:#8B5CF6
    style epic1b fill:#F59E0B
    style epic8 fill:#fbbf24
```

**Note**: Epic 1A (Crypto/VIBES) and Epic 1B (Karma/KARMA) are positioned as foundational primitives alongside Mira (Epic 1). All three receive infrastructure from Epic 0 and provide capabilities to all downstream epics. This ensures conscious gamification and Web3 features are integrated from day one rather than bolted on later.
...
- **Mira** provides omnipresent AI intelligence
- **VIBES** provides omnipresent financial capability (transferable utility token)
- **KARMA** provides omnipresent recognition (non-transferable reputation score)
...
- Provides: 
  ...
  - **Crypto context awareness**: Wallet balance, pending transactions, reward explanations
- Integration Points:
  - **Onboarding**: Welcome, intention setting, first practice guidance, wallet creation
  - **Profile Building**: Progressive disclosure prompts, completion encouragement
  - **Practice Tracking**: Daily reminders, streak celebrations, VIBES reward announcements
  - **Discovery**: Connection recommendations with explanations, conversation starters
  - **Messaging**: Message composition help, relationship insights, payment assistance
  - **Business Interaction**: Service recommendations, booking assistance, crypto payment guidance
  - **Communities**: Group suggestions, event reminders, treasury explanations
  - **Impact**: Feature explanations, voting prompts, VIBES-weighted voting help
- Dependencies: Claude AI, comprehensive user state (all tables), context-aware prompt library, CryptoRouterService

**Crypto Router Service** (Epic 1A - Platform-Wide Financial Layer):
- Used by: Every epic requiring financial transactions or token interactions
- Provides:
  - Wallet creation and management (hybrid custodial/non-custodial)
  - P2P transfers via @handle
  - VIBES token rewards distribution
  - Staking pool management
  - Community treasury operations
  - Payment request creation and fulfillment
  - Multi-chain abstraction (Base L2, Solana, Polygon)
  - Fiat on-ramp coordination
  - Transaction monitoring and fraud detection
- Integration Points:
  - **Onboarding**: Automatic wallet creation on signup
  - **Profile**: Display @handle, wallet settings, payment QR codes
  - **Practices**: VIBES rewards for completions, streak multipliers, Soul-Bound NFT minting
  - **Discovery**: In-chat payments, payment requests, split payments
  - **Impact**: VIBES-weighted voting, staking for commitment signaling
  - **Business**: Accept USDC, instant crypto payouts, direct tipping
  - **Communities**: Shared treasury, crowdfunding, dues payment
  - **Monetization**: Crypto subscriptions, staking for premium, affiliate crypto payouts
- Dependencies: Chain adapters (Base, Solana, Polygon), MPC key management, token contracts, KarmaRouterService (for VIBES multipliers)

**Karma Router Service** (Epic 1B - Platform-Wide Recognition Layer):
- Used by: Every epic to track and reward positive actions
- Provides:
  - KARMA score tracking and calculation
  - Level progression and VIBES multiplier calculation
  - Badge earning and management
  - Leaderboard calculation and caching
  - Planetary impact tracking (trees, carbon offset)
  - Celebration triggers for milestones
  - Mira KARMA context for AI awareness
- Integration Points:
  - **Onboarding**: Initialize KARMA score, first action awards
  - **Profile**: Display KARMA level badge, category breakdown, badge showcase
  - **Practices**: Award KARMA for practice completion, streak milestones, reflections
  - **Discovery**: Filter by KARMA level, show KARMA on connection cards
  - **Impact**: Enhanced dashboard with KARMA and planetary visualization
  - **Business**: Award KARMA for bookings, reviews, tips
  - **Communities**: Community KARMA leaderboards, collective KARMA tracking
  - **Monetization**: KARMA level unlocks perks, higher KARMA = better VIBES earning
- Dependencies: CryptoRouterService (for SBT minting), Planetary partner APIs (OneTreePlanted)
...
**11 Epic Specifications** (detailed standalone modules):
- Epic 0: Foundation (infrastructure and tooling)
- Epic 1: Mira (onboarding and AI companion)
- **Epic 1A: Crypto (Web3 financial layer, wallets, VIBES tokens)**
- **Epic 1B: Karma (conscious gamification, KARMA score, planetary impact)**
...
**16 Technical Reference Documents** (detailed specifications):
...
- **Crypto router (multi-chain Web3 orchestration)**
- **VIBES tokenomics (reward structure and staking)**
- **Karma layer (recognition engine, badges, planetary tracking)**
...
**Total**: 28 comprehensive documents, 550+ pages
...
**VIBES Token**: VIBEUP's native utility token used for rewards, staking, payments, and governance. Users earn VIBES through practices, streaks, and community contributions.

**Hybrid Wallet**: A wallet architecture that combines custodial convenience (no seed phrases, social login) with non-custodial security (users can export keys). Automatically created on signup.

**@handle**: User's unique identifier for P2P payments. Send money by typing @username instead of wallet addresses.

**Soul-Bound Token (SBT)**: Non-transferable NFT representing achievements and milestones (e.g., 100-practice badge, 30-day streak). Cannot be sold or transferred, preserving authenticity.

**Community Treasury**: Shared wallet managed by community moderators for crowdfunding events, paying contributors, and collective financial decisions.

**VIBES-Weighted Voting**: Governance mechanism where vote weight is influenced by VIBES token balance, rewarding engaged community members with more influence.

**Crypto Router Service**: Central service abstracting blockchain complexity, enabling multi-chain support while presenting a simple interface to the application layer.

**Staking**: Locking VIBES tokens to unlock premium features, increase voting power, or signal commitment to initiatives. Staked tokens earn rewards over time.
...
**Epic Documents**: `/vibeup-design-spec/epics/epic-*.md`

**Technical Specs**: `/vibeup-design-spec/architecture/[data-models|api-reference|service-layer|etc].md`

**Crypto Architecture**: [`crypto-router.md`](architecture/crypto-router.md) - Multi-chain service layer specification

**VIBES Tokenomics**: [`vibe-tokenomics.md`](architecture/vibe-tokenomics.md) - Token economics, rewards, and staking
