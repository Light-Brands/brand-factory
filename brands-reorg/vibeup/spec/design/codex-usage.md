...
2. ../design/tools/cursor-prompt-base.txt

Use the appropriate template from ../design/templates/ for your task.

After implementation, validate with:
node tools/check-consistency.js [file-path]
...
```
Read ../design/tools/cursor-prompt-base.txt first.
...
Use ../design/templates/component-template.tsx as the base.
Reference ../design/templates/example-community-card.tsx for patterns.
```

**Creating a New Page:**

```
Follow the design system in ../design/guidelines.md.
...
Use ../design/templates/page-template.tsx as the starting point.
Reference ../design/templates/example-discover-page.tsx for patterns.
```

**Creating a New Hook:**

```
Read ../design/tools/cursor-prompt-base.txt and follow all rules.
...
Base it on ../design/templates/hook-template.ts.
```
...
1. ../design/guidelines.md - Complete design patterns and standards
2. ../design/existing-patterns.json - Detailed pattern examples
3. ../design/templates/ - Use appropriate template for your task

ENFORCEMENT RULES:
━━━━━━━━━━━━━━━━━━

1. COMPONENT CREATION
   → Read ../design/templates/component-template.tsx
...
2. PAGE CREATION
   → Read ../design/templates/page-template.tsx
...
□ Read relevant template from ../design/templates/
...
```bash
# Check specific file
node tools/check-consistency.js path/to/file.tsx
