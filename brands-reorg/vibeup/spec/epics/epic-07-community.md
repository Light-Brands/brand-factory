...
8. **Community Treasury** (Epic 1A Integration): Shared wallet for collective financial operations
   - Pay membership dues in USDC or VIBES tokens
   - Crowdfund events, retreats, and initiatives
   - Transparent on-chain financial reporting
   - Community rewards pool for active contributors
   - Tip contributors directly from treasury
   - **Mira explains treasury mechanics and encourages participation**
...
**Community Treasury & Dues (Epic 1A Integration)**:
- "This community has monthly dues of 50 VIBES. You can pay with your earned tokens or USDC."
- "The retreat is 80% funded! Contribute to the crowdfund and help make it happen."

**Community KARMA System (Epic 1B Integration)**:
Communities have collective KARMA tracking and recognition features:

**Community Collective KARMA**:
- Total KARMA generated by all members displayed
- Community KARMA leaderboard (members ranked)
- Community-level badges for collective milestones
- Karma-based recognition in community feeds

**Community KARMA Actions**:
- Host community event: +200 KARMA
- Post with engagement: +5-50 KARMA (based on reactions)
- Answer question in community: +15 KARMA
- Receive "helpful" from community member: +25 KARMA
- Rally others to initiative: +25 KARMA per person joined
- Welcome new community member: +10 KARMA

**Community Challenges with KARMA**:
- "30-Day Practice Challenge" with KARMA rewards
- Leaderboards for challenge participants
- Bonus KARMA for challenge completion
- Community milestone celebrations

**Karma-Based Community Features**:
- High-KARMA members highlighted in community
- KARMA level shown on all community posts
- Community moderators selected from high-KARMA members
- KARMA-gated features for engaged members

**Mira Community KARMA**:
- "Welcome Sarah to Conscious Creators! Welcoming new members earns +10 KARMA."
- "The community has generated 50,000 KARMA collectively. You're part of something special!"
- "Your helpful answer earned +25 KARMA—you're now #3 on the community leaderboard!"
- "Host an event for your community? +200 KARMA and deep impact on your tribe."
- "Your contributions to this community total 200 VIBES. You're a top supporter!"
- "The community treasury is transparent—you can see all transactions and how funds are used."
- "As a top contributor, the community just sent you 25 VIBES from the rewards pool. Thank you for showing up!"
...
3. **Tab Navigation**:
   - Tabs displayed: **VIBESS | MEMBERS | ABOUT**
   - **First-time visitors (not yet members)**: Automatically shown ABOUT tab first to learn about the community
   - **Existing members**: Automatically shown VIBESS tab first for active engagement
...
3. **Business + Community Profile Structure**:
   ...
   **Top-Level Tabs**:
   ...
   - **[COMMUNITY NAME 1]** → Sub-tabs: VIBESS | MEMBERS
   - **[COMMUNITY NAME 2]** → Sub-tabs: VIBESS | MEMBERS
   - (Multiple communities for Premium businesses)
   
4. **Individual Community Sections**:
   - Each community shows its name above its VIBESS | MEMBERS tabs
   - Brief community-specific description appears on the VIBESS tab
...
Business Profile → Top Tabs:
  ...
  - [Community 1] → VIBESS | MEMBERS
  - [Community 2] → VIBESS | MEMBERS
```
...
- Appears as a modal or prominent banner on first visit to VIBESS tab
...
**Implementation**:
- Search bar at top of VIBESS and MEMBERS tabs
...
**Search Scope**:
- **Within VIBESS Tab**: Search posts/vibes only
...
- Displayed prominently in VIBESS feed or as pinned posts
 ...
 * - Join/Connect button
 * - Tabs: VIBESS | MEMBERS | ABOUT
 * 
 * Tab Logic:
 * - Non-members or first-time visitors → ABOUT tab default
 * - Existing members → VIBESS tab default
 * 
 * ABOUT Tab Contains:
...
- Tab navigation (VIBESS | MEMBERS | ABOUT)
