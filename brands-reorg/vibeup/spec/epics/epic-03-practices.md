...
8. **VIBES Token Rewards** (Epic 1A Integration): Earn VIBES tokens for completing practices—**Mira explains reward multipliers and celebrates earnings**
   - Base reward: 10 VIBES per practice completion
   - Streak multipliers: 1.5x at 7 days, 2x at 30 days, 3x at 100 days
   - Soul-Bound Achievement NFTs for milestones (100 practices, 30-day streak, 365-day streak)
   - Daily affirmation bonus: 5 VIBES for morning affirmations
...
- "7 days in a row! This is where transformation begins—when practice becomes who you are. ✨ You've earned 75 VIBES this week!"
- "You've practiced 47 of the last 60 days. That's 78% consistency—incredible dedication."
- "15 days straight! Notice how different you feel when practice is part of your rhythm? Your 1.5x streak multiplier is active!"

**VIBES Token Rewards (Epic 1A Integration)**:
- "🎉 You just earned 10 VIBES for completing your practice! Keep showing up to earn more."
- "Your 7-day streak just activated the 1.5x multiplier—you'll now earn 15 VIBES per practice!"
- "30 days of practice! You've unlocked the 2x multiplier and earned a Soul-Bound achievement NFT. This is yours forever. 💎"
- "You've earned 500 VIBES this month. That's enough to unlock premium features or tip a connection!"

**KARMA Recognition System (Epic 1B Integration)**:
Every practice action earns KARMA for recognition alongside VIBES for utility:
- Practice logged: +5 KARMA (base)
- 7-day streak milestone: +50 KARMA
- 30-day streak milestone: +200 KARMA  
- 100-day streak milestone: +500 KARMA
- Reflection added (>50 characters): +10 KARMA
- Higher KARMA level = faster VIBES earning (up to 2x multiplier at Level 8+)

**KARMA Badges from Practices**:
- "First Steps" (Bronze): Complete first practice
- "Week Warrior" (Silver): 7-day streak
- "Month Master" (Gold): 30-day streak
- "Century Club" (Diamond): 100 practices

**Mira KARMA Celebrations**:
- "🧘 +5 KARMA for showing up! Your Guardian level gives you 1.75x VIBES on every practice."
- "🔥 7-day streak! +50 KARMA earned and you've unlocked the Week Warrior badge!"
- "Your consistency is building something beautiful. You've earned 847 KARMA from practices alone."
- "30 days of practice! +200 KARMA and you're now a Flourishing member of VIBEUP."
...
- **New (Epic 1A)**: 60%+ active users earn VIBES through practice weekly
- **New (Epic 1A)**: 25%+ users reach 7-day streak multiplier (1.5x rewards)
- **New (Epic 1A)**: 5%+ users earn Soul-Bound NFT for 100 practices
