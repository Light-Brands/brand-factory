# ChoZen IP Platform Specification
...
The ChoZen IP Platform is a mobile-first application that serves as the central gathering place for everyone touched by Tony Cho's vision of regenerative living. It connects book readers, course students, retreat guests, and regenerative enthusiasts into a thriving community.
...
| **The Retreat Guest** | Visited CCRL, wants to stay connected | Community, continued practice, return visits |
...
| **Retreat Life** | CCRL experiences, nature, wildlife |
...
> **Note:** CCRL membership/portal may be developed under ChoZen IP and licensed to CCRL (TBD).
...
*The ChoZen IP Platform—where regenerative living becomes a movement.*
